...
export const COMING: readonly unknown[] = [
  soon('guid-maxq', 2, 1, 'explore', [3, 4], ['q_max'],
  ...
  soon('guid-peg', 2, 2, 'engineer', [4], ['G01'],
  ...
  soon('guid-nav', 2, 3, 'engineer', [4], ['G02'],
  ...
  soon('ctl-inspector', 4, 1, 'engineer', [5], ['G03'],
  ...
  soon('ctl-margins', 4, 2, 'engineer', [5], ['G04', 'E04'],
  ...
  soon('ctl-step', 4, 3, 'engineer', [5], ['E04'],
  ...
  soon('ctl-notch', 4, 4, 'engineer', [5], ['P05'],
  ...
  soon('adv-landing', 5, 1, 'explore', [4, 3], ['recovery'],
  ...
  soon('adv-docking', 5, 2, 'explore', [2, 4], ['G07'],
